...
const toppingsMap: Record<string, React.ReactNode> = {
  pepperoni: (
    ...
    <div className={`relative w-full h-full rounded-full ${selectedIngredients.includes('dough') ? 'bg-pizza-crust' : 'bg-gray-200'} shadow-lg`}>
      ...
      {isCooked && !isPizzaFailed && (
        <div 
          ...
          style={{
            backgroundImage: 'radial-gradient(circle, rgba(255, 235, 150, 0.1) 0%, rgba(165, 80, 42, 0.3) 100%)',
